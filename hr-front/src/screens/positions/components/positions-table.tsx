...
import { positionsTableColumns } from "@/screens/positions/components/positions-table-columns";
...
export const PositionsTable = () => {
  ...
  const { data, isLoading } = usePositions({ pagination });
        ...
        <Table>
          ...
          <TableBody>
            {table.getRowModel().rows?.length ? (
              ...
              <TableRow>
                <TableCell
                  colSpan={positionsTableColumns.length}
