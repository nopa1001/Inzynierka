...
const index$1 = require("./index-VNrhelPn.js");
...
const ListView$1 = React.lazy(() => Promise.resolve().then(() => require("./ListView-sPJmnanv.js")));
const RecursivePath = () => {
...
const ListView = React.lazy(() => Promise.resolve().then(() => require("./ListView-sPJmnanv.js")));
const App = () => {
  const { formatMessage } = reactIntl.useIntl();
...
//# sourceMappingURL=index--7pqTw_-.js.map
