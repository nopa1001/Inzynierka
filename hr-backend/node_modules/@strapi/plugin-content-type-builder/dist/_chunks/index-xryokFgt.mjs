...
const ListView$1 = lazy(() => import("./ListView-UGomcA_U.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-UGomcA_U.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-xryokFgt.mjs.map
