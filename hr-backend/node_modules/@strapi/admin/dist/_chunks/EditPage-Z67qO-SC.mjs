...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-KTSQuD27.mjs";
...
import { u as useWebhooks } from "./useWebhooks-a3eBJpF9.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-21zTYIpO.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-Z67qO-SC.mjs.map
