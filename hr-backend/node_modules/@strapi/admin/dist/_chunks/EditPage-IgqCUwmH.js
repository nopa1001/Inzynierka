...
const useWebhooks = require("./useWebhooks-2dIs3KP1.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-kxRwmlPl.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-IgqCUwmH.js.map
