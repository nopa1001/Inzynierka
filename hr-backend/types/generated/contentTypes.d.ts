...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    dateHired: Attribute.Date & Attribute.Required;
    monthlySalary: Attribute.Decimal;
...
export interface ApiApplicationApplication extends Schema.CollectionType {
  ...
  attributes: {
    ...
    salaryExpectations: Attribute.String & Attribute.Required;
    state: Attribute.Enumeration<['PENDING', 'APPROVED', 'REJECTED']> &
...
export interface ApiScheduleSchedule extends Schema.CollectionType {
  ...
  attributes: {
    ...
    user: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    type: Attribute.Enumeration<['WORK']> & Attribute.DefaultTo<'WORK'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiVacationVacation extends Schema.CollectionType {
  ...
  attributes: {
    ...
    date_from: Attribute.DateTime;
    date_to: Attribute.DateTime;
    type: Attribute.Enumeration<['SICK_LEAVE', 'VACATION']>;
    state: Attribute.Enumeration<['REJECTED', 'APPROVED', 'PENDING']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
